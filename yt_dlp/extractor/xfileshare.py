...
class XFileShareIE(InfoExtractor):
    ...
    _TESTS = [{
        ...
        'url': 'https://gounlimited.to/abcd1234efgh',
        'only_matching': True,
    }, {
        'url': 'https://highstream.tv/abcd1234efgh',
        'only_matching': True,
    }, {
        'url': 'https://vedbam.xyz/abcd1234efgh',
        'only_matching': True,
    }, {
        'url': 'https://vadbam.net/abcd1234efgh',
        'only_matching': True,
    }, {
        'url': 'https://vidlo.us/abcd1234efgh',
        'only_matching': True,
    }, {
        'url': 'https://viidshar.com/abcd1234efgh',
        'only_matching': True,
    }, {
