...
class VeoIE(InfoExtractor):
    ...
    _TESTS = [
        {
            "url": "https://app.veo.co/matches/cb4afb4e-7947-4a3c-b20c-8e681fda019f-e38d6780/",
            "md5": "d9ac3bb245e919c2b045a941f1be8722",
            "info_dict": {
                "id": "cb4afb4e-7947-4a3c-b20c-8e681fda019f-e38d6780",
                "ext": "mp4",
                "title": "Royal Holloway (H) Semi-Final - 1st half",
                "thumbnail": "re:https://c.veocdn.com/.+/thumbnail.jpg",
                "upload_date": "20250220",
                "timestamp": 1740054264,
                "duration": 2973,
                "view_count": int,
            },
        },
    ...
    def _real_extract(self, url):
        ...
        metadata = self._download_json(f"https://app.veo.co/api/app/matches/{video_id}", video_id)
