...
class ClipRsIE(InfoExtractor):
    ...
    _TESTS = [{
        'url': 'https://www.clip.rs/premijera-4-ruze-okupila-poznate-glumica-u-prekratkoj-haljini-branka-i-gagi-ne-skidaju-osmeh-a-kubura-bez-zene-video/15231',
        'info_dict': {
        ...
        'url': 'https://www.clip.rs/ceca-otputovala-sa-deckom-i-njegovom-cerkom-evo-gde-su-otisli-uzivace-zajedno-u-zimskoj-idili/15690',
        'info_dict': {
