...
class ScrippsNetworksIE(InfoExtractor):
    ...
    _TESTS = [{
        ...
        'info_dict': {
            ...
            'uploader': 'SCNI-SCND',
            'duration': 29.995,
            'thumbnail': 'md5:fc053a8bddb6f849c1cae055f98d879c',
            'timestamp': 1475678834.0,
            'upload_date': '20161005',
            'age_limit': 0,
            'episode': 'The Best of the Best',
            'creators': ['Cooking Channel'],
            'tags': ['promo', 'competition', 'cooking competition', 'cooking challenge', 'amateur home cooks', 'michael bonacini', 'alvin leung', 'claudio aprile', 'masterchef canada', 'cooking channel'],
        },
        'add_ie': ['ThePlatform'],
