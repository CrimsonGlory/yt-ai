...
class ViddlerIE(InfoExtractor):
    ...
    _TESTS = [
        {
            'url': 'https://viddler.com/p/He6x4x',
            'md5': 'a713c18b375dff1ed8ed9f35a3b5390d',
            'info_dict': {
                'id': 'He6x4x',
                'ext': 'mp4',
                'title': 'Boston Building Fire!',
                'description': 'md5:397725718c0ccf38e5ffefb72ed841f7',
                'uploader': 'viddler',
                'duration': 1135.0,
                'timestamp': 1743776297,
