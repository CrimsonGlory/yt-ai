...
class GermanupaIE(InfoExtractor):
    ...
    _TESTS = [{
        ...
        'info_dict': {
            ...
            'duration': 3987,
            'thumbnail': 'md5:ef37a3f01b47ab4c2f7c93b1946b8584',
        },
        ...
        'info_dict': {
            ...
            'track': 'Live vom UX Festival: Neuigkeiten von Figma, Jobmarkt, Agenturszene & Interview zu Sustainable UX',
            'tags': ['UX', 'UXcommunity', 'gUXfestival', 'sustainableUX'],
            'modified_timestamp': 1720545210,
            'modified_date': '20240709',
        },
        'params': {'skip_download': 'm3u8'},
    }, {
