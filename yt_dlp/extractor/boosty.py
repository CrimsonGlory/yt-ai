...
class BoostyIE(InfoExtractor):
    ...
    _TESTS = [{
        ...
        'info_dict': {
            ...
            'description': 'md5:8d86e645b57715219f07d6672a4c8a00',
            'media_type': 'video',
            'uploader': 'Future Music Production',
            'uploader_id': '@FutureMusicProduction',
            'uploader_url': 'https://www.youtube.com/@FutureMusicProduction',
            'channel': 'Future Music Production',
            'channel_id': 'UCKVYrFBYmci1e-T8NeHw2qg',
            'channel_url': 'https://www.youtube.com/channel/UCKVYrFBYmci1e-T8NeHw2qg',
            'duration': 170,
            'thumbnail': 'https://i.ytimg.com/vi/-37FW_YQ3B4/maxresdefault.jpg',
