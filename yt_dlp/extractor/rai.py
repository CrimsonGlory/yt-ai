...
class RaiPlayIE(RaiBaseIE):
    ...
    _TESTS = [
        {
            'url': 'https://www.raiplay.it/video/2026/09/Prigioniera-in-Via-Carcere---Un-giorno-in-Pretura---Puntata-del-06092026-c3f63e95-1143-499f-957d-528af6a48ebd.html',
            'md5': '1dc5152a0e7ca4c5937d1ddeb2c0cfe2',
            'info_dict': {
                'id': 'c3f63e95-1143-499f-957d-528af6a48ebd',
                'ext': 'mp4',
                'title': 'Prigioniera in Via Carcere - Un giorno in Pretura - Puntata del 06/09/2026',
                'alt_title': 'St 2026/27 - Un giorno in pretura - Prigioniera in Via Carcere',
                'description': 'md5:35db49ddee9f15549283f0c4b0d18534',
                'uploader': 'Rai 3',
                'duration': 3133,
                'thumbnail': 'https://www.raiplay.it/dl/img/2026/09/07/1788777274828_IMG_8375.JPG.jpeg',
                'timestamp': 1788355380,
                'upload_date': '20260902',
                'series': 'Un giorno in pretura',
                'season': '2026/27',
                'episode': 'Prigioniera in Via Carcere',
                'release_year': 2026,
                'creators': ['Rai 3'],
            },
        }, {
