...
The only reliable way to check if a site is supported is to try it.
 ...
 - **CNN**
 - **CNNIndonesia**
 - **collabinc**: Collab.inc video library
 ...
 - **DestinationAmerica**
 - **DetikEmbed**
 - **deutschekinemathek**: Deutsche Kinemathek
 - **deutschekinemathek:playlist**: Deutsche Kinemathek streaming program
 - **DeuxM**
 - **DeuxMNews**
 ...
 - **MelonVOD**
 - **memobase**: MEMOBASE von Memoriav
 ...
 - **PBSKids**
 - **pbslearningmedia**: PBS LearningMedia
 - **PearVideo**
 - **PeekVids**
 - **peer.tv**
 - **PeerTube**
